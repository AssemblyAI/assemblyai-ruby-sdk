...
require_relative "lemur_base_params_final_model"
require "json"
...
module AssemblyAI
  module Lemur
    class LemurBaseParams
      ...
      # @param final_model [Lemur::LemurBaseParamsFinalModel] The model that is used for the final prompt after compression is performed. Defaults to "default".
      ...
      def initialize(transcript_ids: nil, input_text: nil, context: nil, final_model: nil, max_output_size: nil,
        ...
        @context = context
        # @type [Lemur::LemurBaseParamsFinalModel] The model that is used for the final prompt after compression is performed. Defaults to "default".
        @final_model = final_model
        # @type [Integer] Max output size in tokens, up to 4000
        @max_output_size = max_output_size
        # @type [Float] The temperature to use for the model. Higher values result in answers that are more creative, lower values are more conservative. Can be any value between 0.0 and 1.0 inclusive.
      ...
      def self.from_json(json_object:)
        ...
        final_model = struct.final_model.to_h.to_json
        final_model = Lemur::LemurBaseParamsFinalModel.from_json(json_object: final_model)
      ...
      def self.validate_raw(obj:)
        ...
        obj.final_model.nil? || Lemur::LemurBaseParamsFinalModel.validate_raw(obj: obj.final_model)
