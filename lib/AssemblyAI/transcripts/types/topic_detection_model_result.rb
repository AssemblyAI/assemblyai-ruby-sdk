...
module AssemblyAI
  module Transcripts
    ...
    class TopicDetectionModelResult
      ...
      # @param status [Hash{String => String}] The status of the Topic Detection model. Either success, or unavailable in the rare case that the model failed.
      ...
      def initialize(status:, results:, summary:, additional_properties: nil)
        # @type [Hash{String => String}] The status of the Topic Detection model. Either success, or unavailable in the rare case that the model failed.
        @status = status
