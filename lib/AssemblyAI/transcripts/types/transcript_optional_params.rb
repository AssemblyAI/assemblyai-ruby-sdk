...
module AssemblyAI
  module Transcripts
    ...
    class TranscriptOptionalParams
      ...
      # @param redact_pii_audio_quality [String] Controls the filetype of the audio created by redact_pii_audio. Currently supports mp3 (default) and wav. See [PII redaction](https://www.assemblyai.com/docs/models/pii-redaction) for more details.
      ...
      def initialize(language_code: nil, punctuate: nil, format_text: nil, dual_channel: nil, webhook_url: nil,
        ...
        # @type [String] Controls the filetype of the audio created by redact_pii_audio. Currently supports mp3 (default) and wav. See [PII redaction](https://www.assemblyai.com/docs/models/pii-redaction) for more details.
