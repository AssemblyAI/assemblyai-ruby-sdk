...
module AssemblyAI
  module Transcripts
    ...
    class TranscriptOptionalParams
      ...
      # @param language_code [Hash{String => String}]
      ...
      # @param boost_param [Hash{String => String}] The word boost parameter value
      ...
      # @param redact_pii_audio_quality [Hash{String => String}] Controls the filetype of the audio created by redact_pii_audio. Currently supports mp3 (default) and wav. See [PII redaction](https://www.assemblyai.com/docs/models/pii-redaction) for more details.
      # @param redact_pii_policies [Array<PII_POLICY>] The list of PII Redaction policies to enable. See [PII redaction](https://www.assemblyai.com/docs/models/pii-redaction) for more details.
      # @param redact_pii_sub [Hash{String => String}]
      ...
      # @param speech_threshold [Float] Reject audio files that contain less than this fraction of speech. Valid values are in the range [0, 1] inclusive.
      # @param summarization [Boolean] Enable [Summarization](https://www.assemblyai.com/docs/models/summarization), can be true or false
      # @param summary_model [Hash{String => String}] The model to summarize the transcript
      # @param summary_type [Hash{String => String}] The type of summary
      ...
      def initialize(language_code: nil, punctuate: nil, format_text: nil, dual_channel: nil, webhook_url: nil,
        ...
        # @type [Hash{String => String}] The word boost parameter value
        ...
        # @type [Hash{String => String}] Controls the filetype of the audio created by redact_pii_audio. Currently supports mp3 (default) and wav. See [PII redaction](https://www.assemblyai.com/docs/models/pii-redaction) for more details.
        @redact_pii_audio_quality = redact_pii_audio_quality
        # @type [Array<PII_POLICY>] The list of PII Redaction policies to enable. See [PII redaction](https://www.assemblyai.com/docs/models/pii-redaction) for more details.
        ...
        # @type [Float] Reject audio files that contain less than this fraction of speech. Valid values are in the range [0, 1] inclusive.
        @speech_threshold = speech_threshold
        # @type [Boolean] Enable [Summarization](https://www.assemblyai.com/docs/models/summarization), can be true or false
        @summarization = summarization
        # @type [Hash{String => String}] The model to summarize the transcript
        @summary_model = summary_model
        # @type [Hash{String => String}] The type of summary
      ...
      def self.from_json(json_object:)
        ...
        boost_param = TRANSCRIPT_BOOST_PARAM.key(struct.boost_param)
        ...
        summary_model = SUMMARY_MODEL.key(struct.summary_model)
        summary_type = SUMMARY_TYPE.key(struct.summary_type)
      ...
      def self.validate_raw(obj:)
        ...
        obj.boost_param&.is_a?(TRANSCRIPT_BOOST_PARAM) != false || raise("Passed value for field obj.boost_param is not the expected type, validation failed.")
        ...
        obj.summary_model&.is_a?(SUMMARY_MODEL) != false || raise("Passed value for field obj.summary_model is not the expected type, validation failed.")
        obj.summary_type&.is_a?(SUMMARY_TYPE) != false || raise("Passed value for field obj.summary_type is not the expected type, validation failed.")
