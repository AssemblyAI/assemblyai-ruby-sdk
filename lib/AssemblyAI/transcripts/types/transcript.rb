...
module AssemblyAI
  module Transcripts
    ...
    class Transcript
      ...
      # @param redact_pii_audio_quality [String] The audio quality of the PII-redacted audio file, if redact_pii_audio is enabled. See [PII redaction](https://www.assemblyai.com/docs/models/pii-redaction) for more information.
      ...
      def initialize(id:, language_model:, acoustic_model:, status:, audio_url:, webhook_auth:, auto_highlights:, redact_pii:, summarization:, language_code: nil, text: nil,
        ...
        @status = status
        # @type [Hash{String => String}] The language of your audio file. Possible values are found in [Supported Languages](https://www.assemblyai.com/docs/concepts/supported-languages). The default value is 'en_us'.
        ...
        # @type [String] The audio quality of the PII-redacted audio file, if redact_pii_audio is enabled. See [PII redaction](https://www.assemblyai.com/docs/models/pii-redaction) for more information.
      ...
      def self.validate_raw(obj:)
        ...
        obj.redact_pii_audio_quality&.is_a?(String) != false || raise("Passed value for field obj.redact_pii_audio_quality is not the expected type, validation failed.")
