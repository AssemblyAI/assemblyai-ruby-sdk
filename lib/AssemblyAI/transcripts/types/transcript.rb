...
module AssemblyAI
  module Transcripts
    ...
    class Transcript
      ...
      # @param status [Hash{String => String}] The status of your transcript. Possible values are queued, processing, completed, or error.
      # @param language_code [Hash{String => String}] The language of your audio file. Possible values are found in [Supported Languages](https://www.assemblyai.com/docs/concepts/supported-languages). The default value is 'en_us'.
      ...
      # @param words [Array<Transcripts::TranscriptWord>] An array of temporally-sequential word objects, one for each word in the transcript. See [Speech recognition](https://www.assemblyai.com/docs/models/speech-recognition) for more information.
      # @param utterances [Array<Transcripts::TranscriptUtterance>] When dual_channel or speaker_labels is enabled, a list of turn-by-turn utterance objects. See [Speaker diarization](https://www.assemblyai.com/docs/models/speaker-diarization) for more information.
      ...
      # @param redact_pii_audio [Boolean] Whether a redacted version of the audio file was generated, either true or false. See [PII redaction](https://www.assemblyai.com/docs/models/pii-redaction) for more information.
      # @param redact_pii_audio_quality [Hash{String => String}] 
      # @param redact_pii_policies [Array<PII_POLICY>] The list of PII Redaction policies that were enabled, if PII Redaction is enabled. See [PII redaction](https://www.assemblyai.com/docs/models/pii-redaction) for more information.
      # @param redact_pii_sub [Hash{String => String}] The replacement logic for detected PII, can be "entity_type" or "hash". See [PII redaction](https://www.assemblyai.com/docs/models/pii-redaction) for more details.
      ...
      # @param summary_model [String] The Summarization model used to generate the summary, if [Summarization](https://www.assemblyai.com/docs/models/summarization) is enabled
      ...
      # @param sentiment_analysis_results [Array<Transcripts::SentimentAnalysisResult>] An array of results for the Sentiment Analysis model, if it is enabled. See [Sentiment analysis](https://www.assemblyai.com/docs/models/sentiment-analysis) for more information.
      ...
      # @param entities [Array<Transcripts::Entity>] An array of results for the Entity Detection model, if it is enabled. See [Entity detection](https://www.assemblyai.com/docs/models/entity-detection) for more information.
      # @param speech_threshold [Float] Defaults to null. Reject audio files that contain less than this fraction of speech. Valid values are in the range [0, 1] inclusive.
      ...
      def initialize(id:, language_model:, acoustic_model:, status:, language_code: nil, audio_url:, text: nil, words: nil, utterances: nil, confidence: nil, audio_duration: nil, punctuate: nil, format_text: nil, dual_channel: nil, webhook_url: nil, webhook_status_code: nil, webhook_auth:, webhook_auth_header_name: nil, speed_boost: nil, auto_highlights:, auto_highlights_result: nil, audio_start_from: nil, audio_end_at: nil, word_boost: nil, boost_param: nil, filter_profanity: nil, redact_pii:, redact_pii_audio: nil, redact_pii_audio_quality: nil, redact_pii_policies: nil, redact_pii_sub: nil, speaker_labels: nil, speakers_expected: nil, content_safety: nil, content_safety_labels: nil, iab_categories: nil, iab_categories_result: nil, language_detection: nil, custom_spelling: nil, auto_chapters: nil, chapters: nil, summarization:, summary_type: nil, summary_model: nil, summary: nil, custom_topics: nil, topics: nil, disfluencies: nil, sentiment_analysis: nil, sentiment_analysis_results: nil, entity_detection: nil, entities: nil, speech_threshold: nil, throttled: nil, error: nil, additional_properties: nil)
        ...
        # @type [Hash{String => String}] The status of your transcript. Possible values are queued, processing, completed, or error.
        @status = status
        # @type [Hash{String => String}] The language of your audio file. Possible values are found in [Supported Languages](https://www.assemblyai.com/docs/concepts/supported-languages).
The default value is 'en_us'.
        ...
        @text = text
        # @type [Array<Transcripts::TranscriptWord>] An array of temporally-sequential word objects, one for each word in the transcript. See [Speech recognition](https://www.assemblyai.com/docs/models/speech-recognition) for more information.
        @words = words
        # @type [Array<Transcripts::TranscriptUtterance>] When dual_channel or speaker_labels is enabled, a list of turn-by-turn utterance objects. See [Speaker diarization](https://www.assemblyai.com/docs/models/speaker-diarization) for more information.
        ...
        # @type [Boolean] Whether a redacted version of the audio file was generated, either true or false. See [PII redaction](https://www.assemblyai.com/docs/models/pii-redaction) for more information.
        @redact_pii_audio = redact_pii_audio
        # @type [Hash{String => String}] 
        @redact_pii_audio_quality = redact_pii_audio_quality
        # @type [Array<PII_POLICY>] The list of PII Redaction policies that were enabled, if PII Redaction is enabled. See [PII redaction](https://www.assemblyai.com/docs/models/pii-redaction) for more information.
        @redact_pii_policies = redact_pii_policies
        # @type [Hash{String => String}] The replacement logic for detected PII, can be "entity_type" or "hash". See [PII redaction](https://www.assemblyai.com/docs/models/pii-redaction) for more details.
        ...
        # @type [String] The Summarization model used to generate the summary, if [Summarization](https://www.assemblyai.com/docs/models/summarization) is enabled
        ...
        # @type [Array<Transcripts::SentimentAnalysisResult>] An array of results for the Sentiment Analysis model, if it is enabled. See [Sentiment analysis](https://www.assemblyai.com/docs/models/sentiment-analysis) for more information.
        ...
        # @type [Array<Transcripts::Entity>] An array of results for the Entity Detection model, if it is enabled. See [Entity detection](https://www.assemblyai.com/docs/models/entity-detection) for more information.
        @entities = entities
        # @type [Float] Defaults to null. Reject audio files that contain less than this fraction of speech. Valid values are in the range [0, 1] inclusive.
      ...
      def self.from_json(json_object:)
        ...
        language_code = TRANSCRIPT_LANGUAGE_CODE.key(struct.language_code)
  ...
  Transcripts::TranscriptWord.from_json(json_object: v)
        ...
        utterances = struct.utterances.map() do | v |
  v = v.to_h.to_json()
  Transcripts::TranscriptUtterance.from_json(json_object: v)
        ...
        auto_highlights_result = struct.auto_highlights_result.to_h.to_json()
        ...
        redact_pii_audio_quality = REDACT_PII_AUDIO_QUALITY.key(struct.redact_pii_audio_quality)
        redact_pii_policies = struct.redact_pii_policies.map() do | v |
  v = v.to_h.to_json()
  PII_POLICY.key(v)
end
        redact_pii_sub = SUBSTITUTION_POLICY.key(struct.redact_pii_sub)
        speaker_labels = struct.speaker_labels
        speakers_expected = struct.speakers_expected
        content_safety = struct.content_safety
        content_safety_labels = struct.content_safety_labels.to_h.to_json()
        ...
        iab_categories_result = struct.iab_categories_result.to_h.to_json()
  ...
  Transcripts::Chapter.from_json(json_object: v)
        ...
        sentiment_analysis_results = struct.sentiment_analysis_results.map() do | v |
  v = v.to_h.to_json()
  Transcripts::SentimentAnalysisResult.from_json(json_object: v)
end
        entity_detection = struct.entity_detection
        entities = struct.entities.map() do | v |
  v = v.to_h.to_json()
  Transcripts::Entity.from_json(json_object: v)
      ...
      def self.validate_raw(obj:)
        ...
        obj.language_code&.is_a?(TRANSCRIPT_LANGUAGE_CODE) != false || raise("Passed value for field obj.language_code is not the expected type, validation failed.")
        ...
        obj.redact_pii_audio_quality&.is_a?(REDACT_PII_AUDIO_QUALITY) != false || raise("Passed value for field obj.redact_pii_audio_quality is not the expected type, validation failed.")
        ...
        obj.redact_pii_sub&.is_a?(SUBSTITUTION_POLICY) != false || raise("Passed value for field obj.redact_pii_sub is not the expected type, validation failed.")
