...
module AssemblyAI
  module Transcripts
    ...
    class SentimentAnalysisResult
      ...
      # @param sentiment [Hash{String => String}] The detected sentiment for the sentence, one of POSITIVE, NEUTRAL, NEGATIVE
      ...
      def initialize(text:, start:, end_:, sentiment:, confidence:, speaker: nil, additional_properties: nil)
        ...
        @end_ = end_
        # @type [Hash{String => String}] The detected sentiment for the sentence, one of POSITIVE, NEUTRAL, NEGATIVE
        @sentiment = sentiment
      ...
      def self.from_json(json_object:)
        ...
        start = struct.start
        end_ = struct.end
        sentiment = SENTIMENT.key(struct.sentiment)
      ...
      def self.validate_raw(obj:)
        ...
        obj.sentiment.is_a?(SENTIMENT) != false || raise("Passed value for field obj.sentiment is not the expected type, validation failed.")
